...
[![Build](https://img.shields.io/github/actions/workflow/status/timothee-haudebourg/{{crate}}/ci.yml?branch=main&style=flat-square)](https://github.com/timothee-haudebourg/{{crate}}/actions)
